export const movieNow = {
    ...
    "results": [
      ...
      },
      {
        ...
        "overview": "인류를 지키기 위해 만들어진 AI가 LA에 핵폭탄을 터뜨린 후, 인류와 AI 간의 피할 수 없는 전쟁이 시작된다. 전직 특수부대 요원 ‘조슈아’는 실종된 아내의 단서를 얻을지도 모른다는 생각에 전쟁을 끝내기 위한 인류의 작전에 합류한다. 인류를 위협할 강력한 무기와 이를 창조한 ‘창조자’를 찾아 나서고, 그 무기가 아이 모습의 AI 로봇 '알피'란 사실을 알게 되는데… 인간적인가, 인간의 적인가? 10월, SF 블록버스터의 신세계가 펼쳐진다!",
        "popularity": 252.839,
      ...
      },
      {
        ...
        "overview": "2차 세계대전 마지막 날 독일은 남은 무기로 미국과 미군을 무찔러 최후의 승리 쟁취를 갈망한다. 독일 해군과 마지막으로 남은 U보트 함대는 남은 병력을 총동원해 미국의 뉴욕을 공격할 작전을 펼치는데.... 1, 2차 세계대전을 겪은 독일의 한스 케슬러(돌프 룬드그렌) 함장은 전세를 뒤집는 데 협력하기 위해 소집되고 ‘씨울프’로 알려진 작전을 시작한다.",
        "popularity": 54.925,
      ...
      },
      {
        ...
        "overview": "세계 최고의 킬러들 앞으로 초대장이 도착한다 한 곳에 모인 킬러들은 킬러들의 왕을 암살하고 최고의 킬러를 가리는 시합에 초청된 것 생존 게임이 시작되면, 단 한 놈만 살아남는다! 역대급 킬러 서바이벌을 만난다! 최후의 승자를 확인하라!",
        "popularity": 51.238,
      ...
      },
      {
        ...
        "original_title": "Bula",
        "overview": "세탁소에서 일하는 ‘멜디’는 남몰래 고객들의 옷을 이용해 그녀만의 은밀한 판타지를 즐긴다. 그러다 매력적인 경찰관 ‘팔마’를 만나고 그 남자를 손에 넣기로 결심하는데…",
        "popularity": 22.048,
      ...
      },
      {
        ...
        "overview": "도시에 사는 '피에트로'와 산에 남은 유일한 아이 '브루노'  알프스에서 만나 친구가 된 두 소년은 자연을 누비며 우정을 나눈다. 그 후 성인이 된 '피에트로'는 아버지 '조반니'가 세상을 떠난 뒤 산으로 돌아오고 '브루노'와 재회한다.",
        "popularity": 17.97,
      ...
      },
      {
        ...
        "original_title": "IO",
        "overview": "가련한 눈망울의 회색 당나귀 EO는 세상의 전부였던 서커스단으로부터 구조된 뒤, 폴란드와 이탈리아를 가로지르는 긴 여정에 오른다. 평화로운 농장, 훌리건으로 가득한 축구장, 공포의 소시지 공장, 쇠락 직전의 저택... 다양한 공간을 오가며 겪은 인간 세계는 다정하면서도 잔혹하다.",
        "popularity": 19.716,
      ...
      },
      {
        ...
        "overview": "대대로 마을을 지켜 온 당주집 장손이지만  정작 귀신은 믿지 않는 가짜 퇴마사 천박사. 사람의 마음을 꿰뚫는 통찰력으로 온갖 사건을 해결해온 그에게 귀신을 보는 의뢰인 유경이 찾아와 1억원이라는 수임료로 거절하기 힘든 제안을 한다. 천박사는 파트너 인배와 함께 유경의 집으로 향하고 그곳에서 벌어지는 사건을 쫓으며 자신과 얽혀 있는 부적인 설경의 비밀을 알게 되는데…",
        "popularity": 22.199,
      ...
      },
      {
        ...
        "overview": "드림쏭 이후 1년, ‘버디’와 그의 밴드 ‘트루 블루’는 팬들의 열렬한 사랑을 받으며 눈의 마을의 인기 스타가 된다. ‘트루 블루’의 음악과 화려한 퍼포먼스 실력을 본 엔터테인먼트계의 거물 ‘랭’은 월드 클래스 스타 ‘리틀 폭시’와의 세계 투어 콘서트를 제안하고, ‘트루 블루’는 꿈을 위해 세계 투어 버스에 오른다. 하지만 ‘랭’의 친절한 제안에는 ‘버디’의 음악 에너지를 훔쳐 세계를 장악하려는 음흉한 계획이 숨겨져 있었는데.. 과연 ‘버디’는 ‘랭’으로부터 음악 에너지를 되찾고, 진정한 뮤직 쏘울로 세계를 지켜낼 수 있을까? 10월, 다시 함께 노래해!",
        "popularity": 20.538,
      ...
      },
      {
        ...
        "overview": "한때 마약 왕이었던 프랭크 화이트는 오랜 징역형을 마친 후, 뉴욕으로 돌아와 자신의 사업에 방해되는 인물들을 제거해 나간다. 그 과정에서 총격 살인 사건을 벌인 부하들이 경찰에 체포되자 유능한 변호사를 통해 막대한 보석금을 내고 그들을 석방시킨다. 그리고 자신이 예전에 살던 동네의 병원을 현대화하기 위해 마약 사업으로 번 돈을 기부 하며 정치계와 손을 잡는 등 점점 거물이 되어 간다. 한편 이러한 과정을 알고 있는 경찰 몇 명이 상부의 허락도 없이 프랭크 일당을 습격을 하는데…",
        "popularity": 17.501,
      ...
      {
        "adult": false,
        "backdrop_path": "/elqCaVi6Amkx5hzPsJ3Km5Ru3Yg.jpg",
        "genre_ids": [
          53
        ],
        "id": 813079,
        "original_language": "ko",
        "original_title": "타겟",
        "overview": "평범한 직장인 수현은 이사 후 세탁기를 중고거래로 구매하지만, 고장 난 세탁기를 받고 사기를 당했다는 사실을 알게 된다. 잠적한 판매자를 찾아내는데 성공한 수현은 그의 게시글마다 사기꾼이라는 댓글을 남겨 거래를 방해한다. 그날 이후 수현에게는 정체 모를 전화, 주문한 적 없는 음식 배달, 한밤 중 찾아오는 의문의 남자들까지 소름 끼치는 일들이 연이어 벌어진다. 개인 정보는 모두 유출되었고, 집안 곳곳에는 낯선 흔적들이 발견되면서 서서히 모든 일상이 파괴되기 시작한다. 드디어 본격적인 수사가 진행되고, 주형사와 중고거래 판매자의 집을 찾아간 수현은 그곳에서 시체를 발견하는데…",
        "popularity": 17.866,
        "poster_path": "/rrSc1TOgVjYyS9EXU5U4dLtlKb8.jpg",
        "release_date": "2023-08-30",
        "title": "타겟",
        "video": false,
        "vote_average": 5,
      ...
      },
      {
        ...
        "overview": "그리 머지않은 미래의 뉴욕, 레이첼과 앨비 커플은 기술의 발달에 따라 더욱더 편리한 삶을 살고 있다. 떠오르는 기술 회사의 중역인 레이첼은 자궁 센터의 탐나는 자리를 차지한다. 이곳은 분리 가능한 인공 자궁, 팟을 통해 커플들에게 편리하게(또한 부담을 나누며) 아이를 가질 기회를 제공한다. 그런데 자연에 깊은 애정을 지닌 식물학자인 앨비는 자연 임신을 원한다. 하지만 왜 그게 ‘자연스러운’ 것인가? 레이첼의 AI 테라피스트도 말한다. 이렇게 해서 부모가 되는 목표를 향한 기술로 포장된 길이 시작된다.",
        "popularity": 15.367,
      ...
      },
      {
        ...
        "overview": "여덟 살 난 딸, 투병 중인 아버지와 파리의 매일을 살아가고 있는 산드라는 어느 날 오랜 친구 클레망을 만나 새로운 사랑을 시작한다. 일과 가족, 사랑 사이에서 삶은 계속되고 때로는 눈물이 왈칵 쏟아지려 하지만 아침은 여느 때와 같이 찬란하게 찾아온다.",
        "popularity": 15.091,
